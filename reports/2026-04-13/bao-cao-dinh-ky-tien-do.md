...
OCR exact match hiện tại: 33.3%. Chúng em dự kiến cải thiện bằng:
  • Regex post-processing (match format biển VN theo QCVN 40:2019)
...
9.3. Phương hướng đếm xe

Hiện tại hệ thống detect + track xe nhưng chưa đếm theo hướng.
Chúng em dự kiến dùng line-crossing (vẽ đường ảo trên frame, đếm khi centroid
xe cắt qua đường theo hướng vào/ra).

Xin thầy cho ý kiến nên dùng line-crossing hay zone-based counting, hoặc
phương pháp khác phù hợp hơn với bối cảnh cổng trường.

9.4. Đề xuất bổ sung chức năng

Nếu còn thời gian, chúng em muốn bổ sung thêm:
...
Xin thầy cho ý kiến nên ưu tiên bổ sung chức năng nào, hoặc có chức năng
nào khác cần thiết hơn cho bài toán.
